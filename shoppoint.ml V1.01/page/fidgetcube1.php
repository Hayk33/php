...
<script type="text/javascript">
  VK.init({apiId: 5895270, onlyWidgets: true});
</script>
	<meta charset="utf-8">
	 <link rel="stylesheet" type="text/css" href="../style/style.css">
	<title>Հակասթրես կուբ</title>
...
<h2 align="center">Հակասթրես կուբ</h2>
<div class="all_1">
  <div align="left">
<img src="../images/1.jpg" id="generalImg">
</div>
<div class="all_">
<div class="all">
  <div>
    <img src="../images/1-1.jpg" class="iconImg">
  </div>
  </div>
  <div class="all">
  <div>
    <img src="../images/1-2.jpg" class="iconImg">
  </div>
  </div>
  <div class="all">
  <div>
    <img src="../images/1-3.jpg" class="iconImg">
  </div>
  </div>
  <div class="all">
  <div>
    <img src="../images/1-4.jpg" class="iconImg">
  </div>
  </div>
  </div>
  </div>
...
<div class="about_">
  <pre class="about">
    Ջրակայուն-այո
    Որակ-բարձր
    Գույնը-սև,կանաչ,Կարմիր,սպիտակ,սպիտակ
